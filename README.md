 ...
 * no-collapse - Boolean, default: false
 * secondary-bg-on-hover - Boolean, default: false - By default the no-collapse property will also remove the highlighting on mouse over. Set this to true to reinstate the highlithing
